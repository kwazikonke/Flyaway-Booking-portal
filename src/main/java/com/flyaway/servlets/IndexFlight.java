...
/**
 * Servlet implementation class IndexFlight
 */
@WebServlet("/IndexFlight")
public class IndexFlight extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("<a href='Logout'style='color:black'>Log out</a> &nbsp; &nbsp; &nbsp;| &nbsp; &nbsp; &nbsp; <a href='AddFlight.html'style='color:black'>Add Flight</a> &nbsp; &nbsp; &nbsp;| &nbsp; &nbsp; &nbsp;<a href='AdminDashboard.html'style='color:black'>Dashboard</a> ");
			out.print("<br>");
			out.print("<br>");
			...
			for (Flight fl:list) {
				...
				out.print("<td><a href='DeleteFlight?fId="+fl.getFlightid()+"'>Delete</a></td>");
